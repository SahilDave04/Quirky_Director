...
def test_main():
    ...
    DisplayTree(custom_path,maxDepth=2,ignoreList=["__pycache__"])
    ...
    DisplayTree(maxDepth=4, showHidden=True, ignoreList=["__pycache__"])

    # 7. Test for Export TXT
    DisplayTree(maxDepth=4, showHidden=True, ignoreList=["__pycache__"], exportTxt=True)
